<%@ Page Title="PROFİLİM" Language="C#" MasterPageFile="~/MusteriMenusu.Master" AutoEventWireup="true" CodeBehind="MusteriProfilim.aspx.cs" Inherits="Banka_Web_Site.MusteriProfilim" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        *{
        ...
        .profil .alt .doldurulacak-alan{
            text-align:center;
            margin-top:20px;
        }
        .profil .alt .doldurulacak-alan .label{
            color:indianred;
            margin-top:7px;
        }
        .profil .alt .doldurulacak-alan .textbox{
            color:indianred;
            border:1px solid indianred;
            margin-top:7px;
        }
        .profil .alt .doldurulacak-alan .btnTemizle{
            float:left;
            width:100px;
            height:40px;
            line-height:40px;
        ...
        .profil .alt .doldurulacak-alan .btnGuncelle{
            float:right;
            width:100px;
            height:40px;
            line-height:40px;
        ...
        .profil .alt .doldurulacak-alan .button:hover{
            color:lightgray;
        }
        </style>
</asp:Content>
    ...
    <div class="profil">
        ...
        <div class="alt">
            <div class="doldurulacak-alan">
                <asp:Label ID="lblID" runat="server" Text="Müşteri Numarası:" CssClass="label"></asp:Label>
