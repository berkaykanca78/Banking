<%@ Page Title="PARA YATIRMA" Language="C#" MasterPageFile="~/MusteriMenusu.Master" AutoEventWireup="true" CodeBehind="ParaYatirma.aspx.cs" Inherits="Banka_Web_Site.ParaYatirma" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        *{
        ...
        .hesap .alt .doldurulacak-alan .btnParaYatir{
            width:120px;
            height:40px;
            line-height:40px;
            text-align:center;
    ...
    <div class="hesap">
        ...
        <div class="alt">
            <div class="doldurulacak-alan">
                ...
                <br />
                <asp:Label ID="lblTutar" Text="Yatırılacak Tutar: " runat="server" CssClass="label"> </asp:Label> &nbsp
                <asp:TextBox ID="txtTutar" runat="server" CssClass="textbox" TextMode="Number"></asp:TextBox>
                <br />
                <asp:Button ID="btnParaYatir" runat="server" Text="PARA YATIR" CssClass="btnParaYatir" OnClick="btnParaYatir_Click"/>
                <br /><br />
